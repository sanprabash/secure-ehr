...
function DoctorSidebar() {
  ...
  const fullName = user ? `Dr. ${user.firstName} ${user.lastName}` : 'Doctor';
  ...
  return (
    <div style={styles.sidebar}>
      ...
      <div style={styles.userCard}>
        ...
        <div style={styles.userRole}>{user?.specialisation} · {user?.hospital}</div>
      </div>
      ...
      <nav style={styles.nav}>
        ...
        <div
          style={isActive('/doctor/dashboard') ? {...styles.navItem, ...styles.navItemActive} : styles.navItem}
        ...
        <div
          style={isActive('/doctor/patients') ? {...styles.navItem, ...styles.navItemActive} : styles.navItem}
        ...
        <div
          style={isActive('/doctor/notifications') ? {...styles.navItem, ...styles.navItemActive} : styles.navItem}
        ...
        <div
          style={isActive('/doctor/profile') ? {...styles.navItem, ...styles.navItemActive} : styles.navItem}
