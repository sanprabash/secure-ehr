          ...
          <div style={styles.twoCol}>
            ...
            {selected && (
              <div style={styles.detailPanel}>
                ...
                <div style={styles.detailSection}>Who Accessed This Record</div>
                <div style={styles.accessRow}>
                  <div style={styles.accessAvatar}>{user?.firstName[0]}{user?.lastName[0]}</div>
...
const styles = {
  ...
  detailFilename: { fontSize: '12px', color: '#666', textAlign: 'center', marginBottom: '14px' },
